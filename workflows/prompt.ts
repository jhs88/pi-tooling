...
export const WORKFLOW_TOOL_DESCRIPTION = [
  "Call this tool only when the user explicitly requests a workflow run. Never trigger it from a keyword, infer permission from task complexity, or substitute it for ordinary ad hoc Agent delegation.",
...
export const WORKFLOW_PROMPT_GUIDELINES = [
  "Use workflow only after the user explicitly asks for a workflow run; keep ordinary or ad hoc delegation on the existing Agent tool.",
