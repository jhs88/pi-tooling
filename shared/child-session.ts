...
export const CHILD_EXCLUDED_TOOL_NAMES = [
  // Installed @tintinweb/pi-subagents orchestration tools.
  "Agent",
  "get_subagent_result",
  "steer_subagent",
  // Upstream recursive subagent tools retained for defensive compatibility.
  "subagent_spawn",
  "subagent_wait",
  "subagent_cancel",
  "subagent_check",
 ...
 */
export function createChildModelRuntime(agentDir = getAgentDir()) {
